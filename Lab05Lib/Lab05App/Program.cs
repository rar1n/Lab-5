    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            foreach (Town t in arrTowns)
            {
                ...
                Console.WriteLine("---------------------------------");
                Console.WriteLine("Краiна: " + t.Country);
                ...
                Console.WriteLine(t.HasPort ? "У мiстi є порт" : "У мiстi немає порту");
                Console.WriteLine(t.HasAirport ? "У мiстi є аеропорт" : "У мiстi немає аеропорту");
